...
function handlePageAction(tabInfo) {
  chrome.tabs.query({active:true,currentWindow:true},function(tabArray){
    if (tabArray[0].url.match(/\/\/www\.imdb.com\/.+\/tt\d{7}\//) || tabArray[0].url.match(/.*thetvdb\.com\/.*id\=\d{1,7}/) || tabArray[0].url.match(/.*trakt\.tv\/(shows|movies)\//) || tabArray[0].url.match(/.*rottentomatoes.com\/(m|tv)\//)) {
